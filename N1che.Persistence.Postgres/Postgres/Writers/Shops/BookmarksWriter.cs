...
public sealed class BookmarksWriter : IBookmarksWriter
{
    private readonly PostgresConnectionFactory _connectionFactory;

    public BookmarksWriter(PostgresConnectionFactory connectionFactory)
    {
    ...
    public async Task Create(Guid shopId, string userId, CancellationToken cancellationToken)
    {
        ...
        {
            throw new DuplicateRequestException(EntityTypes.Bookmark, shopId);
        }
